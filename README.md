...
*   **Resources**:
    *   **Coins (🪙)**: Dropped from bricks as they are damaged. Spent in the Shop on temporary upgrades. Resets after each run.
    *   **Gems (💎)**: A premium currency occasionally found in bricks. Used for permanent upgrades in the Skill Tree.
    *   **Food (🥕) & Wood (🪵)**: Dropped from bricks. These resources are taken back to the Home Base after the run.
...
*   **Resources**:
    *   **Food (🥕)**: Generated by `Farmland` buildings. Used to purchase certain buildings and produce balls.
    *   **Wood (🪵)**: Generated by `Sawmill` buildings. Used to purchase buildings.
...
*   **Level 5**: **Gems (💎)** and the **Skill Tree** unlocked.
...
### Equipment System
Unlocked at Level 10, allowing players to customize balls with passive abilities.
